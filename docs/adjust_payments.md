...
When an order comes in, the plugin creates it in Shopware and checks the state of the payment with
[Vipps MobilePay's ePayment API](https://developer.vippsmobilepay.com/api/epayment/#tag/QueryPayments/operation/getPayment).
