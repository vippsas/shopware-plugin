...
If you want to refund a part of the captured amount, then you just change the amount you want to and then click `Refund`. It will change the Payment Status to `Partial refunded`.
