...
| Exposure of test/development credentials | Confidentiality | Developers might accidentally commit test API credentials or tokens that could be used against test environments. | • Use of placeholder values in all examples<br>• Test credentials rotation policy<br>• Separate test/production API keys<br>• Environment variable usage documented |
